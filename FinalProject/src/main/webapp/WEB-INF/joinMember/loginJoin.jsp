   ...
   <div class="login-join">
      ...
      <span class="login-join-subtitle2">이런여행 회원이 되어 더욱 다양한 혜택을 누려보세요.</span>
               ...
               <table class="login-join-table">
                  ...
                  <th class="login-join-table-title2">SNS 간편로그인</th>
                  </tr>         
                  <tr>
                     ...
                     <span class = login-join-text>카카오 아이디로 간편로그인</span></button></td>
                  </tr>
                  ...
                  <tr>
                     ...
                     <span class ="login-join-text">네이버 아이디로 간편로그인</span></button></td>
                  </tr>
                  <tr>
